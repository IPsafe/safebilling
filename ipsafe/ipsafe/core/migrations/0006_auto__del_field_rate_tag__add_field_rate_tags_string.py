...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rate.tag'
        db.delete_column(u'rate', 'tag')

        # Adding field 'Rate.tags_string'
        db.add_column(u'rate', 'tags_string',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field tag on 'Rate'
        m2m_table_name = u'rategroup_ratetag'
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rate', models.ForeignKey(orm[u'core.rate'], null=False)),
            ('ratetag', models.ForeignKey(orm[u'core.ratetag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['rate_id', 'ratetag_id'])


    def backwards(self, orm):
        # Adding field 'Rate.tag'
        db.add_column(u'rate', 'tag',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Rate.tags_string'
        db.delete_column(u'rate', 'tags_string')

        # Removing M2M table for field tag on 'Rate'
        db.delete_table(u'rategroup_ratetag')
