...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.callerid_number'
        db.add_column(u'device', 'callerid_number',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.callerid_number'
        db.delete_column(u'device', 'callerid_number')
