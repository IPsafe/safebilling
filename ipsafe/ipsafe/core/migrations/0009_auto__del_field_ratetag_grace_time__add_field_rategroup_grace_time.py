...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RateTag.grace_time'
        db.delete_column(u'rate_tag', 'grace_time')

        # Adding field 'RateGroup.grace_time'
        db.add_column(u'rate_group', 'grace_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RateTag.grace_time'
        db.add_column(u'rate_tag', 'grace_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Deleting field 'RateGroup.grace_time'
        db.delete_column(u'rate_group', 'grace_time')
