...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CdrTries.hangup_cause'
        db.add_column(u'cdr_tries', 'hangup_cause',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CdrTries.hangup_cause_q850'
        db.add_column(u'cdr_tries', 'hangup_cause_q850',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CdrTries.hangup_cause'
        db.delete_column(u'cdr_tries', 'hangup_cause')

        # Deleting field 'CdrTries.hangup_cause_q850'
        db.delete_column(u'cdr_tries', 'hangup_cause_q850')
