...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cdr.user_rate_gracetime'
        db.add_column(u'cdr', 'user_rate_gracetime',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Cdr.provider_rate_gracetime'
        db.add_column(u'cdr', 'provider_rate_gracetime',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cdr.user_rate_gracetime'
        db.delete_column(u'cdr', 'user_rate_gracetime')

        # Deleting field 'Cdr.provider_rate_gracetime'
        db.delete_column(u'cdr', 'provider_rate_gracetime')
