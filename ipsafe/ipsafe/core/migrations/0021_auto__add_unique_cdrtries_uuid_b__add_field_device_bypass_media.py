...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.bypass_media'
        db.add_column(u'device', 'bypass_media',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Device.bypass_media'
        db.delete_column(u'device', 'bypass_media')
    ...
    models = {
        ...
        u'core.cdrtries': {
            ...
            'uuid_b': ('django.db.models.fields.CharField', [], {'max_length': '80', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'core.codec': {
