...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cdr.hangup_commentary'
        db.add_column(u'cdr', 'hangup_commentary',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.commentary'
        db.add_column(u'cdr', 'commentary',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.sip_via_host'
        db.add_column(u'cdr', 'sip_via_host',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.sip_to_port'
        db.add_column(u'cdr', 'sip_to_port',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.sip_user_agent'
        db.add_column(u'cdr', 'sip_user_agent',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.sip_contact_uri'
        db.add_column(u'cdr', 'sip_contact_uri',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cdr.hangup_commentary'
        db.delete_column(u'cdr', 'hangup_commentary')

        # Deleting field 'Cdr.commentary'
        db.delete_column(u'cdr', 'commentary')

        # Deleting field 'Cdr.sip_via_host'
        db.delete_column(u'cdr', 'sip_via_host')

        # Deleting field 'Cdr.sip_to_port'
        db.delete_column(u'cdr', 'sip_to_port')

        # Deleting field 'Cdr.sip_user_agent'
        db.delete_column(u'cdr', 'sip_user_agent')

        # Deleting field 'Cdr.sip_contact_uri'
        db.delete_column(u'cdr', 'sip_contact_uri')
    ...
    models = {
        ...
        u'core.cdr': {
            ...
            'commentary': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'hangup_commentary': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'provider_rate_gracetime': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            ...
            'sip_contact_uri': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'sip_received_ip': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'sip_to_port': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'sip_user_agent': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'sip_via_host': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'user_rate_gracetime': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '80', 'unique': 'True', 'null': 'True'}),
        ...
        u'core.cdrtries': {
            'Meta': {'object_name': 'CdrTries', 'db_table': "u'cdr_tries'"},
            'cdr': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Cdr']", 'null': 'True', 'blank': 'True'}),
            'endpoint_disposition': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Gateway']", 'null': 'True', 'blank': 'True'}),
            'hangup_cause': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'hangup_cause_q850': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'provider_rate_name': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'uuid_a': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'uuid_b': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'})
        },
        u'core.codec': {
        ...
        u'core.customer': {
            ...
            'max_calls': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'core.customerbalance': {
            'Meta': {'object_name': 'CustomerBalance', 'db_table': "u'customer_balance'"},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Customer']", 'null': 'True', 'blank': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Gateway']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Provider']", 'null': 'True', 'blank': 'True'}),
            'total': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '4', 'blank': 'True'})
        },
        u'core.device': {
            ...
            'bypass_media': ('django.db.models.fields.BooleanField', [], {}),
            'callerid': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'callerid_number': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
        ...
        u'core.rategroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'rate_type': ('django.db.models.fields.CharField', [], {'max_length': '15'})
        },
        u'core.ratetag': {
