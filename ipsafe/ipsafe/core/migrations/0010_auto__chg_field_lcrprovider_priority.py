...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LcrProvider.priority'
        db.alter_column(u'lcr_provider', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'LcrProvider.priority'
        db.alter_column(u'lcr_provider', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
