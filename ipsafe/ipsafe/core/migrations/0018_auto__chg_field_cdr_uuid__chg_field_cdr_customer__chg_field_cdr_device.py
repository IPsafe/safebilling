...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cdr', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=80, unique=True, null=True))

        # Changing field 'Cdr.customer'
        db.alter_column(u'cdr', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Customer'], null=True))

        # Changing field 'Cdr.device'
        db.alter_column(u'cdr', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Device'], null=True))

    def backwards(self, orm):

        # Changing field 'Cdr.uuid'
        db.alter_column(u'cdr', 'uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=80, unique=True))

        # Changing field 'Cdr.customer'
        db.alter_column(u'cdr', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Customer']))

        # Changing field 'Cdr.device'
        db.alter_column(u'cdr', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Device']))
    ...
    models = {
        ...
        u'core.cdrtries': {
            ...
            'cdr': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Cdr']"}),
            'endpoint_disposition': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Gateway']", 'null': 'True', 'blank': 'True'}),
            'hangup_disposition': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
