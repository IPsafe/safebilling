...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rate.price'
        db.alter_column(u'rate', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))

        # Changing field 'Provider.postpaid_limit'
        db.alter_column(u'provider', 'postpaid_limit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'Rate.price'
        db.alter_column(u'rate', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Provider.postpaid_limit'
        db.alter_column(u'provider', 'postpaid_limit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        u'core.provider': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'postpaid_limit': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '5', 'blank': 'True'}),
