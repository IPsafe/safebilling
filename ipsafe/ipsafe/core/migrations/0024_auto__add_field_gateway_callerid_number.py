...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gateway.callerid_number'
        db.add_column(u'gateway', 'callerid_number',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gateway.callerid_number'
        db.delete_column(u'gateway', 'callerid_number')
