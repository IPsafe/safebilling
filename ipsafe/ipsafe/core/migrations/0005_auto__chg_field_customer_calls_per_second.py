...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.calls_per_second'
        db.alter_column(u'customer', 'calls_per_second', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Customer.calls_per_second'
        db.alter_column(u'customer', 'calls_per_second', self.gf('django.db.models.fields.PositiveIntegerField')())
