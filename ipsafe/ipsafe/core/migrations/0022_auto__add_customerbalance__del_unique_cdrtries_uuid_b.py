...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CdrTries', fields ['uuid_b']
        db.delete_unique(u'cdr_tries', ['uuid_b'])

        # Adding model 'CustomerBalance'
        db.create_table(u'customer_balance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Customer'], null=True, blank=True)),
            ...
            ('total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=4, blank=True)),
        ))
        db.send_create_signal(u'core', ['CustomerBalance'])


    def backwards(self, orm):
        # Deleting model 'CustomerBalance'
        db.delete_table(u'customer_balance')

        # Adding unique constraint on 'CdrTries', fields ['uuid_b']
        db.create_unique(u'cdr_tries', ['uuid_b'])
