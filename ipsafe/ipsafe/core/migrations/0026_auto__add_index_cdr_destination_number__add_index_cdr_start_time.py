...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Cdr', fields ['destination_number']
        db.create_index(u'cdr', ['destination_number'])

        # Adding index on 'Cdr', fields ['start_time']
        db.create_index(u'cdr', ['start_time'])


    def backwards(self, orm):
        # Removing index on 'Cdr', fields ['start_time']
        db.delete_index(u'cdr', ['start_time'])

        # Removing index on 'Cdr', fields ['destination_number']
        db.delete_index(u'cdr', ['destination_number'])
    ...
    models = {
        ...
        u'core.cdr': {
            ...
            'destination_number': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '40', 'null': 'True', 'blank': 'True'}),
