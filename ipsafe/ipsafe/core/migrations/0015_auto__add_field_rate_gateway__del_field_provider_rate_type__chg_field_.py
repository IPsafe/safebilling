...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rate.gateway'
        db.add_column(u'rate', 'gateway',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Gateway'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Provider.rate_type'
        db.delete_column(u'provider', 'rate_type')


        # Changing field 'Provider.rate_group'
        db.alter_column(u'provider', 'rate_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.RateGroup']))
        # Deleting field 'Gateway.rate_group'
        db.delete_column(u'gateway', 'rate_group_id')


    def backwards(self, orm):
        # Deleting field 'Rate.gateway'
        db.delete_column(u'rate', 'gateway_id')

        # Adding field 'Provider.rate_type'
        db.add_column(u'provider', 'rate_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


        # Changing field 'Provider.rate_group'
        db.alter_column(u'provider', 'rate_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RateGroup'], null=True))
        # Adding field 'Gateway.rate_group'
        db.add_column(u'gateway', 'rate_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.RateGroup'], null=True, blank=True),
                      keep_default=False)
