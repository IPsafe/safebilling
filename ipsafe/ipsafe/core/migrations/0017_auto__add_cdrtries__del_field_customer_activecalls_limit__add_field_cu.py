...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CdrTries'
        db.create_table(u'cdr_tries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cdr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Cdr'])),
            ('uuid_a', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
        ...
        db.send_create_signal(u'core', ['CdrTries'])

        # Deleting field 'Customer.activecalls_limit'
        db.delete_column(u'customer', 'activecalls_limit')

        # Adding field 'Customer.max_calls'
        db.add_column(u'customer', 'max_calls',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.sip_received_ip'
        db.add_column(u'cdr', 'sip_received_ip',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CdrTries'
        db.delete_table(u'cdr_tries')

        # Adding field 'Customer.activecalls_limit'
        db.add_column(u'customer', 'activecalls_limit',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Customer.max_calls'
        db.delete_column(u'customer', 'max_calls')
