...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CdrTries.cdr'
        db.alter_column(u'cdr_tries', 'cdr_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Cdr'], null=True))

    def backwards(self, orm):

        # Changing field 'CdrTries.cdr'
        db.alter_column(u'cdr_tries', 'cdr_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Cdr']))
